...
typedef struct gps_info_s {
	float timestamp_position;			/**< Timestamp for position information */
	...
	float timestamp_velocity;			/**< Timestamp for velocity informations */

	float cog;                      /**< GPS ground yaw 0-360 >**/
	...
	float timestamp_time;			/**< Timestamp for time information */
	float time_utc_usec;				/**< Timestamp (microseconds, UTC), this is the timestamp which comes from the gps module. It might be unavailable right after cold start, indicated by a value of 0 */
	float height;
	float hMSL;
	float ecefX;
	float ecefY;
